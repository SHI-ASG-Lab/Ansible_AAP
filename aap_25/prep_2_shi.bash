...
echo "[automationcontroller:vars]" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "peers=execution_nodes" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# Execution nodes 
echo "[execution_nodes]" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# Automation hub
echo "[automationhub]" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "$AH" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# EDA 
echo "[automationedacontroller]" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "$EDA" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# DB
echo "[database]" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
...
echo "registry_password='$RHPASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# Gateway config
echo "# Gateway configuration" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationgateway_admin_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationgateway_pg_host=$DB" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationgateway_pg_database='automationgateway'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
...
echo "pg_database='awx'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "pg_username='awx'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
...
echo "# Automation Hub Configuration" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationhub_admin_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationhub_pg_host=$DB" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "automationhub_pg_port=5432" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationhub_pg_database='automationhub'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationhub_pg_username='automationhub'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationhub_pg_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "automationhub_pg_sslmode='prefer'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# EDA config 
echo "# Event Driven Automation Configuration" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationedacontroller_admin_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationedacontroller_pg_host=$DB" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "automationedacontroller_pg_port=5432" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationedacontroller_pg_database='automationedacontroller'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationedacontroller_pg_username='automationedacontroller'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "automationedacontroller_pg_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory

# Uncomment the lines below if using AAP 2.4
# SSO configuration
#echo "# SSO Configuration" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "sso_keystore_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "sso_console_admin_password='$PASS'" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
#echo "" >> /home/shi/ansible-automation-platform-setup-2.5-1/inventory
echo
