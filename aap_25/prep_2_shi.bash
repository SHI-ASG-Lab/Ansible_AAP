...
mv /home/shi/Ansible_AAP/update_hosts_file.yml /home/shi/ansibleprep/update_hosts_file.yml
...
ansible-playbook -i /home/shi/ansibleprep/inventory.yml /home/shi/ansibleprep/update_hosts_file.yml
...
curl -o /home/shi/$AAP_ZIP $STORAGE_ACCT/$AAP_ZIP
echo
...
echo "automationgateway_admin_email='somefool@someplace.com'" >> /home/shi/$DIR_NAME/inventory
echo "" >> /home/shi/$DIR_NAME/inventory
