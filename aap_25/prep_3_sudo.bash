...
# 3. Next it creates the SSH keys for root and copies them to each vm.  This part is interactive and will require the user to enter the password set in the first script for the root account.
